...
Env.AddNPCSpawn(village, "NPC_Bartender",  { X = 64 * CELL + CELL * 0.5, Y = 46 * CELL + CELL * 0.5, Z = 0 }, { Pitch = 0, Yaw = 180, Roll = 0 })
Env.AddNPCSpawn(village, "NPC_Blacksmith", { X = 56 * CELL + CELL * 0.5, Y = 55 * CELL + CELL * 0.5, Z = 0 }, { Pitch = 0, Yaw = 180, Roll = 0 })
Env.AddNPCSpawn(village, "NPC_Camper",     { X = 78 * CELL + CELL * 0.5, Y = 68 * CELL + CELL * 0.5, Z = 0 }, { Pitch = 0, Yaw = 90, Roll = 0 })
...
-- ============ 放置路人NPC ============
World.SpawnNPC("Merchant_Male","stranger",{X=18123.896562,Y=21699.952339,Z=4801.289646})
World.SpawnNPC("Merchant_Male","stranger",{X=18112.476759,Y=20919.064547,Z=4801.289646})
World.SpawnNPC("Hunter_Male","fountain",{X=18807.022713,Y=21029.507053,Z=4801.289595})
World.SpawnNPC("Ironworker_Male","fountain",{X=19156.411824,Y=21041.120300,Z=4801.289595})
World.SpawnNPC("Merchant_Male","stranger",{X=19846.186257,Y=20904.379527,Z=4801.289646})
World.SpawnNPC("Merchant_Male","stranger",{X=19895.166275,Y=21727.607176,Z=4801.289646})
World.SpawnNPC("Ironworker_Male","blacksmith",{X=18435.358699,Y=24033.350965,Z=4801.289667})
World.SpawnNPC("Hunter_Male","stranger",{X=18275.395733,Y=17230.504604,Z=4781.830001})
World.SpawnNPC("Hunter_Male","stranger",{X=15175.186154,Y=18410.595883,Z=4794.210492})
World.SpawnNPC("Merchant_Male","stranger",{X=22804.840795,Y=20196.378221,Z=4801.266624})
World.SpawnNPC("Merchant_Male","stranger",{X=20160.242286,Y=21257.960130,Z=4801.266624})
World.SpawnNPC("Assassin_Male","stranger",{X=18431.693682,Y=22249.976359,Z=4801.289614})
World.SpawnNPC("Assassin_Male","stranger",{X=16189.880132,Y=20108.363571,Z=4781.670688})
World.SpawnNPC("Ironworker_Male","stranger",{X=17454.158979,Y=15841.673003,Z=4770.655170})
